                  ...
                  return (
                    <div className="rank-item">
                      {d.rankName && (
                        <div>
                          ...
                          <Input
                            ...
                            value={values[`${selectValue}-${d._id}-rankName`]}
                      ...
                      {d.pointsRequired && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={handleChange}
                            value={
                              values[`${selectValue}-${d._id}-pointsRequired`]
                            }
                      ...
                      <Button
                        type="primary"
                        onClick={() =>
                          updateHandler({ select: selectValue, type: d._id })
                        }
                      >
                        Update
                      </Button>
                    ...
                    return (
                      <div className="quest-item">
                        ...
                        {d.userId && (
                          <div>
                            ...
                            <Input
                              ...
                              onChange={handleChange}
                              value={values[`${selectValue}-${d.type}-userId`]}
                        ...
                        {d.message && (
                          <div>
                            ...
                            <Input
                              ...
                              onChange={handleChange}
                              value={values[`${selectValue}-${d.type}-message`]}
                        ...
                        <Button
                          type="primary"
                          onClick={() =>
                            updateHandler({ select: selectValue, type: d.type })
                          }
                        >
                          Update
                        </Button>
                      ...
                      {d.channelId && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={handleChange}
                            value={values[`${selectValue}-${d.type}-channelId`]}
                            name={`${selectValue}-${d.type}-channelId`}
                          />{" "}
                        </div>
                      )}
                      ...
                      {d.points && (
                        <div>
                          ...
                          <Input
                            ...
                            onChange={handleChange}
                            value={values[`${selectValue}-${d.type}-points`]}
                    ...
                    <div className="user-item">
                      {d.name && (
                        <div>
                          {" "}
                          <p>
                            Task Name: {values[`${selectValue}-${d._id}-name`]}
                          </p>{" "}
                        </div>
                      )}
                      {d.description && (
